...
!function (i, e) {
    ...
    e.createBarChart = function (e, t) {
        var a = i(e).data("colors"), l = a ? a.split(",") : c.concat(), n = new britecharts.miniTooltip,
            u = new britecharts.bar, o = d3.select(e), r = !!o.node() && o.node().getBoundingClientRect().width,
        ...
        var a = i(e).data("colors"), l = a ? a.split(",") : c.concat(), n = new britecharts.bar, u = d3.select(e),
        ...
        var a = i(e).data("colors"), l = a ? a.split(",") : c.concat(), n = britecharts.donut(),
        ...
        var e = [{name: "Mon", value: 2100}, {name: "Tue", value: 5e3}, {name: "Wed", value: 4e3}, {
                name: "Thu",
                value: 5500
            }, {name: "Fri", value: 6500}, {name: "Sat", value: 4500}, {name: "Sun", value: 3500}], t = {
                dataByTopic: [{
                    topic: 103,
            ...
            }, a = [{name: "Shiny", id: 1, quantity: 86, percentage: 5}, {
                name: "Blazing",
                id: 2,
                quantity: 300,
                percentage: 18
                ...
                quantity: 814,
                percentage: 48
            }], l = [{date: "2018-06-27T07:00:00.000Z", value: 4}, {
                date: "2018-06-28T07:00:00.000Z",
                value: 12
            ...
            n = [{key: "Appetizer", value: 400}, {key: "Soup", value: 300}, {key: "Salad", value: 300}, {
                key: "Lunch",
                value: 250
