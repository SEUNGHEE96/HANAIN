...
options = {
    ...
    dataLabels: {
        enabled: !0, formatter: function (o) {
            return o + "%"
        }, offsetY: 10, style: {fontSize: "12px", colors: ["#304758"]}
    },
    colors: colors,
...
options = {
    ...
    series: [{
        name: "Product A",
        data: [{x: "Team A", y: [1, 5]}, {x: "Team B", y: [4, 6]}, {x: "Team C", y: [5, 8]}, {x: "Team D", y: [3, 11]}]
    }, {
        name: "Product B",
        data: [{x: "Team A", y: [2, 6]}, {x: "Team B", y: [1, 3]}, {x: "Team C", y: [7, 8]}, {x: "Team D", y: [5, 9]}]
    }]
};
